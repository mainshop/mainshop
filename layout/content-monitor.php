<div class="row-kategori">
  <p style="font-size: 30px;padding: 10px;font-family: ubuntu;margin-top: 2%;" class="bg-dark text-light">MONITOR</p>
  
  <div class="row">
    <div class="col-3" style="margin-bottom: 20px;">
      <div class="tcenter card">
        <div class="containerSO">
          <img src="img/monitor.jpeg" alt="Avatar" class="image">
          <div class="overlay">
            <div class="text">
              <button class="buttondetail" onclick="document.getElementById('id08').style.display='block'" style="width:auto;">Detail</button>
            </div>
          </div>
        </div>
        <p style="margin-top:15px">MONITOR BENING</p>
        <p>Rp. 9.000.000</p>
    ...
    <div class="col-3" style="margin-bottom: 20px;">
      <div class="tcenter card">
        <div class="containerSO">
          <img src="img/monitor2.jpeg" alt="Avatar" class="image">
          <div class="overlay">
            <div class="text">
              <button class="buttondetail" onclick="document.getElementById('id08').style.display='block'" style="width:auto;">Detail</button>
            </div>
...
<div id="id08" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php" style="width: 25%; height: auto;">
    <div class="imgcontainer">
      ...
      <img src="img/monitor.jpeg" alt="Avatar" class="avatar">
    </div>

    <div class="container">
      <h1 style="text-align: center;">MONITOR BENING</h1>
